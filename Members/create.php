				...
				require_once 'dbconfig.php';
					...
					if($ans == $spam){
						...
						if($_POST){
							...
							$city = $_POST['city'];
							try{
								$stmt = $db_con->prepare("INSERT INTO member(name,  gender, email,  cdate, city) VALUES(:ename,  :gender, :email, :cdate, :city)");
						...
						<p><a href="home.php" ><button class="button" >Back</button</a></p>
				</div>
	</body>
</html>
