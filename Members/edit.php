...
<tr>
		...
		<tr>
				<td>Gender</td>
				<td> <div class="selector"> <select name="gender" id="g">
...
<?php
selectElement($row['gender']);

function selectElement($valueToSelect) {

	if($valueToSelect == "Male"){
		echo '<script type="text/JavaScript"> document.getElementById("g").getElementsByTagName("option")[0].selected = "selected"; </script>';

	} else{
		echo '<script type="text/JavaScript"> document.getElementById("g").getElementsByTagName("option")[1].selected = "selected"; </script>';
